...
import { useGetNewArrivalsQuery, useGetAllCategoriesQuery } from "../lib/api";
...
function TrendingSection() {
    ...
    // Fetch products based on categoryId (pass null or ALL logic)
    const {
        data: products = [],
        ...
        selectedCategoryId === "ALL" ? "ALL" : selectedCategoryId
    );
            ...
            <div className="relative bg-gradient-to-br from-white/95 via-pink-50/90 to-purple-50/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/50">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
                    <div className="flex-1">
                        ...
                        <p className="text-gray-700 text-lg max-w-2xl leading-relaxed">
                            ✨ Discover the{" "}
                            <span className="font-semibold text-pink-600">newest 6 products</span>{" "}
                            that are taking the world by storm! Fresh picks, trending styles,
                            and must-have items just for you.
                        </p>
                    </div>
                            ...
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-2">
                                    <span className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                                        {latestProducts.length} Latest Products
                                    </span>
                ...
                {latestProducts.length === 6 && (
                    <div className="text-center mt-10">
                        <Link
                            to="/shop"
                            className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                        >
